...
class BillingStatusController(http.Controller):
    ...
    def _serialize_line(self, line):
        ...
        return {
            ...
            'is_preauth_eligible': line.is_preauth_eligible,
            ...
            'sale_order_lines': [
                {
                    ...
                    'is_preauth_eligible': sol.is_preauth_eligible,
    ...
    def _serialize_order(self, order):
        ...
        return {
            ...
            'billing_summary': {
                'visit_total_untaxed': order.ampath_amount_visit_total,
                'insurance_claim_untaxed': order.ampath_amount_insurance_claim,
                'cash_invoiced_untaxed': order.ampath_amount_cash_invoiced,
                'cash_to_invoice_untaxed': order.ampath_amount_cash_to_invoice,
            },
            ...
            'has_preauth_eligible_lines': order.has_preauth_eligible_lines,
            'has_claim_eligible_lines': order.has_claim_eligible_lines,
            'has_claim_submit_lines': order.has_claim_submit_lines,
            'order_lines': lines,
            'invoices': invoices,
        }
