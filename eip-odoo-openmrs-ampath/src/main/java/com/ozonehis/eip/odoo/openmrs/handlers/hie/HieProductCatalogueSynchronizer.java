...
public class HieProductCatalogueSynchronizer {
    ...
    public void sync() throws Exception {
        ...
        log.info(
                "HIE sync complete: {} active GEs, {} active packages",
                activeGeCodes.size(),
                activePackageCodes.size());
    }

    private Map<String, String> syncForms() throws Exception {
        ...
        log.info("Synced {} HIE forms", names.size());
        return names;
    }

    private Map<String, String> syncUnits() throws Exception {
        Map<String, String> names = new HashMap<>();
        ...
        log.info("Synced {} HIE units", names.size());
        return names;
    }

    private void syncRoutes() throws Exception {
        int count = 0;
